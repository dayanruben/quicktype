...
export class SwiftRenderer extends ConvenienceRenderer {
    ...
    private renderHeader(type: Type, name: Name): void {
        if (this.leadingComments !== undefined) {
            ...
            if (
                this._options.protocol.hashable ||
                this._options.protocol.equatable
            ) {
                this.emitLine("//");
    ...
    protected propertyLinesDefinition(
        name: Name,
            ...
            () => {
                ...
                if (!this._options.justTypes) {
                    ...
                    if (!allPropertiesRedundant && c.getProperties().size > 0) {
                        ...
                        if (
                            this._options.codingKeysProtocol &&
                ...
                if (
                    ...
                    for (const property of initProperties) {
                        ...
                        propertiesLines.push(
                            property.name,
                            ": ",
                            this.swiftPropertyType(property.parameter),
                        );
                    }

                    if (
                        this.propertyCount(c) === 0 &&
                        this._options.objcSupport
                    ) {
    ...
    protected initializableProperties(c: ClassType): SwiftProperty[] {
        ...
        this.forEachClassProperty(
            c,
            "none",
            (name, jsonName, parameter, position) => {
...
encoder.dateEncodingStrategy = .formatted(formatter)`);
    ...
    private renderUnionDefinition(u: UnionType, unionName: Name): void {
        ...
        this.emitBlockWithAccess(
            [indirect, "enum ", unionName, this.getProtocolString("enum")],
            () => {
                    ...
                    this.emitBlockWithAccess(
                        ...
                        () => {
                            ...
                            if (maybeNull !== null) {
                                ...
                                this.indent(() =>
                                    this.emitLine("try container.encodeNil()"),
                                );
                            }
